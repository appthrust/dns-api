module github.com/appthrust/dns-api
...
require (
	...
	github.com/appthrust/local-irsa v0.0.0-20260527222328-0f4d7677aa9a // indirect
...
tool github.com/appthrust/local-irsa/cmd/local-irsa
